...
const themes: Array<{ type: ThemeType; name: string; description: string }> = [
  { type: 'plant', name: 'Plant', description: 'Grow beautiful plants' },
...
export function Onboarding({ onComplete }: { onComplete: () => void }) {
  ...
  const [selectedTheme, setSelectedTheme] = useState<ThemeType>('plant');
