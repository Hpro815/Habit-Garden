  ...
  return (
    <div className="relative flex items-center justify-center" style={{ width: dimensions.container, height: dimensions.container }}>
      ...
      <div
        className="absolute rounded-full"
        style={{
          bottom: dimensions.container * 0.15,
          width: dimensions.container * 0.35,
          height: dimensions.container * 0.08,
      ...
      {stage >= 6 && (
        <div
          className="absolute"
          style={{
            bottom: dimensions.container * 0.2 + stemHeight - 10,
          }}
        >
          {/* Outer petals */}
          {[...Array(stage >= 7 ? 8 : 6)].map((_, i) => (
    ...
    <div className="relative flex items-center justify-center" style={{ width: dimensions.container, height: dimensions.container }}>
      ...
      {stage >= 6 && (
        <div
          className="absolute"
          style={{
            bottom: dimensions.container * 0.2 + stemHeight - 15,
          }}
        >
    ...
    <div className="relative flex items-center justify-center" style={{ width: dimensions.container, height: dimensions.container }}>
      ...
      {stage >= 6 && (
        <div
          className="absolute"
          style={{
            bottom: dimensions.container * 0.2 + stemHeight - 18,
          }}
        >
          {/* Outer layer petals */}
    ...
    <div className="relative flex items-center justify-center" style={{ width: dimensions.container, height: dimensions.container }}>
      ...
      {stage >= 6 && (
        <div
          className="absolute"
          style={{
            bottom: dimensions.container * 0.2 + stemHeight - 12,
          }}
        >
  ...
  return (
    <div className="relative flex items-center justify-center" style={{ width: dimensions.container, height: dimensions.container }}>
      ...
      {stage >= 1 && [...Array(stage >= 6 ? 5 : 3)].map((_, i) => {
        const offsetX = (i - (stage >= 6 ? 2 : 1)) * 8;
        const heightVar = stemHeight + (i % 2) * 5;
        return (
          <div key={`stem-${i}`}>
            <div
              className="absolute"
            ...
            {stage >= 4 && (
              <div
                className="absolute"
                style={{
                  bottom: dimensions.container * 0.2 + heightVar - 8,
                  left: '50%',
                  marginLeft: offsetX - 3,
                }}
              >
                {[...Array(stage >= 6 ? 5 : 3)].map((_, j) => (
                  <div
                    key={`flower-${i}-${j}`}
                    className="absolute rounded-full"
                    style={{
      ...
      {stage >= 4 && (
        <>
          {[...Array(stage >= 6 ? 5 : 3)].map((_, i) => {
            ...
            const bellHeight = dimensions.container * 0.2 + stemHeight - 10 - i * 9;
            const xOffset = -7 + (i % 2) * 3; // Moved left to align with stem
            return (
              <div
                key={`bell-${i}`}
                className="absolute"
...
function BluebellCharacter({ stage, dimensions }: { stage: number; dimensions: { container: number; icon: number } }) {
  const scale = 0.5 + (stage * 0.04);
  const stemHeight = 32 + stage * 4;
  const flowerSize = dimensions.icon * 0.50 * scale;
      ...
      {stage >= 4 && (
        <>
          {[...Array(stage >= 6 ? 5 : 3)].map((_, i) => {
            ...
            const bellHeight = dimensions.container * 0.2 + stemHeight - 10 - i * 7;
            const xOffset = -6 + (i % 2) * 2; // Moved left to align with stem
            return (
              <div
                key={`bell-${i}`}
                className="absolute"
