...
const tutorialSteps = [
  ...
  },
  {
    ...
    content: (
      <div className="flex flex-col items-center gap-4">
        <p className="text-center text-gray-900 dark:text-white">
          Choose from beautiful plants, roses, and lilies to represent your habits!
        </p>
        <div className="grid grid-cols-3 gap-3">
          <div className="bg-green-50 dark:bg-green-900/30 p-3 rounded-lg border border-green-200 dark:border-green-800">
            <div className="flex flex-col items-center">
              <AnimatedCharacter theme="plant" stage={4} colorPalette="pastel-green" size="small" />
              <span className="text-sm font-medium mt-1 text-gray-900 dark:text-white">Plant</span>
      ...
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="bg-blue-50 dark:bg-blue-900/30 p-4 rounded-lg border border-blue-200 dark:border-blue-800 w-full">
          ...
          <ul className="text-xs text-blue-700 dark:text-blue-300 space-y-1">
            ...
            <li>• Free plan: 10 habits/month, all flower types</li>
            <li>• Premium: Unlimited habits</li>
          </ul>
        </div>
      </div>
    ),
